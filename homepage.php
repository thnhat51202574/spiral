        ...
        <div class="hp_ynsi_solution_wrap clearfix">
            <div class="hp_yn_si_scolution_list container">
                <div class="hp_yn_si_scolution col-md-4 col-xs-12">
                    ...
                    <div class="hp_yn_si_scolution_bottom">
                        <img src="image/si-social-intranet-text.png" alt="intranet">
                    </div>
                </div>
                <div class="hp_yn_si_scolution col-md-4 col-xs-12">
                    <div class="hp_yn_si_scolution_top">
                    ...
                    <div class="hp_yn_si_scolution_bottom">
                        <img src="image/si-social-solution-text.png" alt="intranet">
                    </div>
                </div>
                <div class="hp_yn_si_scolution col-md-4 col-xs-12">
                    <div class="hp_yn_si_scolution_top">
                    ...
                    <div class="hp_yn_si_scolution_bottom">
                        <img src="image/si-social-modules-text.png" alt="intranet">
                    </div>
                </div>
            </div>
            <div class="hp_yn_si_product_wrap">
                <div class="hp_ynsi_product container">
                    <div class="hp_ynsi_product_left col-md-8 col-sm-12 col-xs-12">
                        <h3>Our Products Reach Across The World</h3>
                        <div class="product_description">
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                        </div>
                        <div class="product_description_img">
                            <img src="image/out_products.png" alt="YouNetSI product">
                        </div>
                    </div>
                    <div class="hp_ynsi_product_right col-md-4 col-md-offset-0 col-sm-8 col-sm-offset-2 col-xs-12">
                        <div class="product_sum row">
                            <div class="product_sum_number col-sm-3 col-xs-12">3,5M</div>
                            <div class="product_sum_detail col-sm-9 col-xs-12"><span>Users all over the world</span></div>
                        </div>
                        <div class="product_sum row">
                            <div class="product_sum_number col-sm-3 col-xs-12">35</div>
                            <div class="product_sum_detail col-sm-9 col-xs-12"><span>Available working tools</span></div>
                        </div>
                        <div class="product_sum row">
                            <div class="product_sum_number col-sm-3 col-xs-12">25</div>
                            <div class="product_sum_detail col-sm-9 col-xs-12"><span>Available inclusive modules for Vietnam  business/organization</span></div>
                        </div>
                        <div class="product_sum row">
                            <div class="product_sum_number col-sm-3 col-xs-12">18</div>
                            <div class="product_sum_detail col-sm-9 col-xs-12"><span>System/Platform/Software cabable of  integrated (eRP, Sharepoin...)</span></div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="hp_yn_si_module_store_wrap">
                <div class="hp_yn_si_module_store container">
                    ...
                    <p class="hp_yn_si_module_store_des">Based on market knowledge of 15-year experience, we provide best social intranet integrated modules that best serve Vietnam business</p>
                                    ...
                                    <div class="module_banner" style="background-color: #000e65;">
                                        <div class="module_banner_content">
                                            <span class="module_banner_img">
						 					<img src="image/contract_module.png" alt="Contract Management">
						 				</span>
                            ...
                            <li class="col-md-4 col-sm-6">
                                <div class="hp_yn_si_module_store_list_item">
                                    <div class="module_banner" style="background-color: #411980;">
                                        <div class="module_banner_content">
                                            <span class="module_banner_img">
						 					<img src="image/check_point_module.png" alt="Check-Point Management">
						 				</span>
                            ...
                            <li class="col-md-4 col-sm-6">
                                <div class="hp_yn_si_module_store_list_item">
                                    <div class="module_banner" style="background-color: #00a7aa;">
                                        <div class="module_banner_content">
                                            <span class="module_banner_img">
						 					<img src="image/business_travel_module.png" alt="Business Travel Management">
						 				</span>
                            ...
                            <li class="col-md-4 col-sm-6">
                                <div class="hp_yn_si_module_store_list_item">
                                    <div class="module_banner" style="background-color: #1e9269;">
                                        <div class="module_banner_content">
                                            <span class="module_banner_img">
						 					<img src="image/official_note_module.png" alt="Official Note Management">
						 				</span>
                            ...
                            <li class="col-md-4 col-sm-6">
                                <div class="hp_yn_si_module_store_list_item">
                                    <div class="module_banner" style="background-color: #0563b8;">
                                        <div class="module_banner_content">
                                            <span class="module_banner_img">
						 					<img src="image/employee_profile_module.png" alt="Employee Profile Management">
						 				</span>
                            ...
                            <li class="col-md-4 col-sm-6">
                                <div class="hp_yn_si_module_store_list_item">
                                    <div class="module_banner" style="background-color: #6aa71b;">
                                        <div class="module_banner_content">
                                            <span class="module_banner_img">
						 					<img src="image/absence_form_module.png" alt="Absence Form Management">
						 				</span>
                ...
                <div class="hp_yn_si_feature_project container">
                    ...
                    <div class="hp_yn_si_feature_project_list_wrap clearfix">
                        <ul class="hp_yn_si_feature_project_list clearfix">
                            <li class="col-md-3 col-sm-6 hp_yn_si_feature_project_list_item">
                                <div class="project_banner">
                                    <div class="project_banner_content">
                                        <div class="project_banner_img">
                                            <img src="image/financial-services-images.png" alt="Financial Services">
                                        </div>
                            ...
                            <li class="col-md-3 col-sm-6 hp_yn_si_feature_project_list_item">
                                <div class="project_banner">
                                    <div class="project_banner_content">
                                        <div class="project_banner_img">
                                            <img src="image/retail-ecommerce-image.png" alt="Retail & e-Commerce">
                                        </div>
                            ...
                            <li class="col-md-3 col-sm-6 hp_yn_si_feature_project_list_item">
                                <div class="project_banner">
                                    <div class="project_banner_content">
                                        <div class="project_banner_img">
                                            <img src="image/health-care-image.png" alt="Health Care">
                                        </div>
                            ...
                            <li class="col-md-3 col-sm-6 hp_yn_si_feature_project_list_item">
                                <div class="project_banner">
                                    <div class="project_banner_content">
                                        <div class="project_banner_img">
                                            <img src="image/education-image.png" alt="Education">
                                        </div>
                            ...
                            <li class="col-md-3 col-sm-6 hp_yn_si_feature_project_list_item">
                                <div class="project_banner">
                                    <div class="project_banner_content">
                                        <div class="project_banner_img">
                                            <img src="image/travel-image.png" alt="Travel, Tourism  & Hospitality">
                                        </div>
                            ...
                            <li class="col-md-3 col-sm-6 hp_yn_si_feature_project_list_item">
                                <div class="project_banner">
                                    <div class="project_banner_content">
                                        <div class="project_banner_img">
                                            <img src="image/telecommunication-image.png" alt="Telecommunication">
                                        </div>
                            ...
                            <li class="col-md-3 col-sm-6 hp_yn_si_feature_project_list_item">
                                <div class="project_banner">
                                    <div class="project_banner_content">
                                        <div class="project_banner_img">
                                            <img src="image/public-service-image.png" alt="Public Service">
                                        </div>
                            ...
                            <li class="col-md-3 col-sm-6 hp_yn_si_feature_project_list_item">
                                <div class="project_banner">
                                    <div class="project_banner_content">
                                        <div class="project_banner_img">
                                            <img src="image/realty-image.png" alt="Realty">
                                        </div>
                    ...
                    <div class="hp_yn_si_request_demo_form clearfix">
                        <div class="hp_yn_si_request_demo_form_content">
                            <form>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <label for="company_question">Company Question</label>
                                        <textarea name="company_question"></textarea>
                                    </div>
                                </div>
